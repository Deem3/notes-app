import { LoginProps } from '@libs/models';
  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center">
      <form
        ...
        className="bg-white w-[25%] h-[40%] [&>*]:w-[70%] [&>*]:my-2 flex flex-col justify-center items-center rounded-xl shadow-md"
      >
        ...
        <p className="text-center cursor-pointer" onClick={() => setPage(false)}>
          to register
        </p>
      </form>
    </div>
