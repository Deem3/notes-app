...
import { RegisterProps } from "@utils/models";
...
export const Register:React.FC<RegisterProps> = (props) => {
  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center">
      <form onSubmit={handleSubmit(formClick)} className="bg-white w-[25%] h-[45%] [&>*]:w-[70%] [&>*]:my-2 flex flex-col justify-center items-center rounded-xl shadow-md">
        ...
        <TextFieldInput type="text" placeholder="firstname" {...register('firstName', {required: true})} />
        <TextFieldInput type="text" placeholder="lastname" {...register('lastName', {required: true})} />
        ...
        <p className="text-center cursor-pointer" onClick={()=>setPage(true)}>to login</p>
      </form>
    </div>
  )
}
